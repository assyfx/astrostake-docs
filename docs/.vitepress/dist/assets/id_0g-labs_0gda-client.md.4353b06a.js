import{_ as s,c as a,o as n,a as l}from"./app.dd4d1028.js";const E=JSON.parse('{"title":"0G DA Client Setup Guide","description":"","frontmatter":{},"headers":[{"level":2,"title":"Requirements","slug":"requirements","link":"#requirements","children":[]},{"level":2,"title":"Install","slug":"install","link":"#install","children":[]},{"level":2,"title":"Stop node","slug":"stop-node","link":"#stop-node","children":[]}],"relativePath":"id/0g-labs/0gda-client.md"}'),e={name:"id/0g-labs/0gda-client.md"},p=l(`<h1 id="_0g-da-client-setup-guide" tabindex="-1">0G DA Client Setup Guide <a class="header-anchor" href="#_0g-da-client-setup-guide" aria-hidden="true">#</a></h1><h2 id="requirements" tabindex="-1">Requirements <a class="header-anchor" href="#requirements" aria-hidden="true">#</a></h2><ul><li>Memory: 8 GB RAM</li><li>CPU: 2 Cores</li><li>Disk: -</li><li>Bandwidth: 100 Mbps (Download / Upload)</li></ul><h2 id="install" tabindex="-1">Install <a class="header-anchor" href="#install" aria-hidden="true">#</a></h2><ol><li><strong>Install necessary packages</strong></li></ol><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki"><code><span class="line"><span style="color:#A6ACCD;">sudo apt-get update</span></span>
